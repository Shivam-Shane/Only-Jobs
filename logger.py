import logging
import os
logger=logging.getLogger("OnlyJobs")               #using named loggers, we can control the logging level for different parts

LOG_FILE = "onlyjobs.log"                       # What type of log file name to use
...
# Configure logging
logging.basicConfig(filename=LOG_FILE_PATH, level=logging.INFO, format='%(filename)s - %(levelname)s - %(message)s')
